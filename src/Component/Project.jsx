  ...
  return (
    <div>
      <div id='' className="my-10">
          ...
          {projek.map((item) => (
            <div className="shadow-lg mb-10 group container rounded-md bg-white mx-auto mr-30 content-div w-48 lg:w-96" data-aos="zoom-in" data-aos-duration="1000" key={item.id}>
              <div>
