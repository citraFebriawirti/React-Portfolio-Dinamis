  ...
  return (
    <div>
      <div id='' className="my-10">
          ...
          {projek.map((item) => (
            <div className="shadow-lg  mb-10 group container rounded-md bg-white  max-w-sm flex justify-center items-center mx-auto content-div" data-aos="zoom-in" data-aos-duration="1000" key={item.id}>
              <div>
                <div className="py-8 px-2 bg-white rounded-b-md fd-cl group-hover:opacity-25 lg:py-8 lg:px-4">
                  <img src={"../image/" + item.image_projek} />
                  <span className="block  text-gray-800 font-bold tracking-wide text-sm text-justify lg:text-lg">{item.span1_projek}</span>
